...
--
-- Host: localhost:3306
-- Generation Time: May 14, 2021 at 05:59 PM
...
CREATE TABLE `activitylog` (
  ...
  `actvity_type` varchar(255) NOT NULL,
...
INSERT INTO `activitylog` (`activityID`, `time`, `activity_desc`, `actvity_type`, `chamber_name`) VALUES
(1, 'current_timestamp(6)', '01', '01', '01'),
(2, '2021-05-14 17:32:42', '01', '01', '01');
...
(1, 'admin', 'admin', 'admin', 'admin', 'active', 'super_admin', '5/14/2021, 5:45:58 PM');
...
--
ALTER TABLE `activitylog`
  MODIFY `activityID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
