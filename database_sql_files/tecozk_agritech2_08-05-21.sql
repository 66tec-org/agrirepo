...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2021 at 08:47 AM
...
(4, 'chamber 1', 'chamber zone 1', 'admin_admin59', 'zone 1', 'farm 2');
...
(4, 'sensor 1', 'sensor 1', 'Actuator', 'Soil Moisture'),
(5, 'sensor 2', 'sensor 2', 'Sensor', 'Humidity'),
(6, 'sensor 3', 'sensor 3', 'Sensor', 'Humidity');
...
(30, 'farm 2', '500', '500', 'Isb', '2021-05-05 23:13:26', 'Inactive', 'admin_admin59');
...
(1, 'admin', 'admin', 'admin', 'admin', 'active', 'user', '5/5/2021, 11:39:30 PM'),
...
(10, 'admin_admin59', '123', 'abdullahrashidimtiaz@gmail.com', '03001234567', '', 'user', '5/5/2021, 11:12:37 PM');
...
(17, 'ggg', 'admin', 'ggg'),
(18, 'hhh', 'admin', 'hhh'),
(19, 'zone 1', 'admin_admin59', 'farm 2');
...
--
ALTER TABLE `component`
  MODIFY `component_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `farm`
--
ALTER TABLE `farm`
  MODIFY `farm_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `zone`
  MODIFY `zone_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
