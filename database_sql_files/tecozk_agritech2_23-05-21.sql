...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2021 at 07:21 PM
...
INSERT INTO `album_gallery` (`img_id`, `username`, `filename`, `path`) VALUES
(1, 'user', '', 'uploads/file_1621777997198.JPG'),
(2, 'user', '', 'uploads/file_1621778605987.JPG'),
(3, 'user', '', 'uploads/file_1621778687306.JPG'),
(4, 'user', '', 'uploads/file_1621778846714.JPG'),
(5, 'user', '', 'uploads/file_1621778877699.JPG'),
(6, 'user', '', 'uploads/file_1621778979742.JPG');
...
(16, 'a', 'a', 'Actuator', 'Soil Moisture', 'a');
...
(1, 'admin', 'admin', 'admin', 'admin', 'active', 'admin', '5/23/2021, 5:49:39 PM'),
(11, 'aa_aa67', 'aa', 'aa@aa', 'aa', '', 'customer', '5/15/2021, 7:21:50 PM'),
(12, 'super', 'super', '', '', '', 'super_admin', '5/23/2021, 5:07:18 PM'),
(13, 'user', 'user', '', '', '', 'customer', '5/23/2021, 7:09:29 PM');
...
--
ALTER TABLE `chamber`
  MODIFY `chamber_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `component`
--
ALTER TABLE `component`
  MODIFY `component_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `farm`
  MODIFY `farm_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `zone`
  MODIFY `zone_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
